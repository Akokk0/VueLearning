  ...
  <div class="goods-container">
    ...
    <div class="thumb">
      <div class="custom-control custom-checkbox">
        <!-- 复选框 -->
        <input @change="stateChange" type="checkbox" class="custom-control-input" :id="'cb' + item.id" :checked="item.goods_state" />
...
export default {
  ...
  methods: {
    stateChange(e) {
      ...
      this.$emit('state-change', {id: this.item.id, value: newState})
